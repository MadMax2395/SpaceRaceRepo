...
class SpaceBonus: SKSpriteNode, GameSprite {
    ...
    func setStaticImageAndSetPhysicsBody(name: String, category:PhysicsCategory) {
        self.texture = textureAtlas.textureNamed(name)
